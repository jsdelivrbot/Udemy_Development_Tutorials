...
var DocumentsComponent = /** @class */ (function () {
    ...
    DocumentsComponent.prototype.getDocuments = function () {
        ...
        this.documentService.getDocuments()
            .subscribe(
        // subscribe is what actually making the call, taks function as arg
        function (documents) { return _this.documents = documents; }, function (error) { return _this.errorMessage = error; });
    };
